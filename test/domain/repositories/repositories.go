...
// Source: gitlab.figo.systems/platform/monoskope/monoskope/pkg/domain/repositories (interfaces: UserRepository,ClusterRepository)
...
import (
	...
	eventsourcing "gitlab.figo.systems/platform/monoskope/monoskope/pkg/eventsourcing"
)
