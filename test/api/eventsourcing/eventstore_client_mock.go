...
// Source: gitlab.figo.systems/platform/monoskope/monoskope/pkg/api/eventsourcing (interfaces: EventStoreClient,EventStore_StoreClient,EventStore_RetrieveClient)
