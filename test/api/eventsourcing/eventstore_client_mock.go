...
// Source: github.com/finleap-connect/monoskope/pkg/api/eventsourcing (interfaces: EventStoreClient,EventStore_StoreClient,EventStore_RetrieveClient)
...
func (m *MockEventStoreClient) RetrieveOr(arg0 context.Context, arg1 *eventsourcing.EventFilters, arg2 ...grpc.CallOption) (eventsourcing.EventStore_RetrieveOrClient, error) {
	...
	ret := m.ctrl.Call(m, "RetrieveOr", varargs...)
	ret0, _ := ret[0].(eventsourcing.EventStore_RetrieveOrClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockEventStoreClientMockRecorder) RetrieveOr(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RetrieveOr", reflect.TypeOf((*MockEventStoreClient)(nil).RetrieveOr), varargs...)
}
