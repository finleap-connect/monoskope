...
var (
	...
	validRole  = common.Role_admin
	validScope = common.Scope_system
...
func NewValidPermissionModel() *domain.PermissionModel {
	return &domain.PermissionModel{
		Roles:  []string{validRole.String(), validRole.String(), validRole.String()},
		Scopes: []string{validScope.String(), validScope.String(), validScope.String()},
	}
}
