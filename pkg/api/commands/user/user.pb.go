...
func (x *AddRoleToUser) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddRoleToUser) ProtoMessage() {}

func (x *AddRoleToUser) ProtoReflect() protoreflect.Message {
	mi := &file_api_commands_user_proto_msgTypes[0]
...
// Deprecated: Use AddRoleToUser.ProtoReflect.Descriptor instead.
func (*AddRoleToUser) Descriptor() ([]byte, []int) {
	return file_api_commands_user_proto_rawDescGZIP(), []int{0}
}

func (x *AddRoleToUser) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *AddRoleToUser) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *AddRoleToUser) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
var file_api_commands_user_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x73, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x22, 0x56, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x52,
	0x6f, 0x6c, 0x65, 0x54, 0x6f, 0x55, 0x73, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78,
	...
	0x6d, 0x61, 0x6e, 0x64, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_api_commands_user_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_commands_user_proto_goTypes = []interface{}{
	(*AddRoleToUser)(nil), // 0: commands.user.AddRoleToUser
}
