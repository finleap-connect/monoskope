...
func (x *UserRoleAddedEventData) Reset() {
	*x = UserRoleAddedEventData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commands_user_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserRoleAddedEventData) Descriptor() ([]byte, []int) {
	return file_api_commands_user_proto_rawDescGZIP(), []int{2}
}
...
var file_api_commands_user_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x22, 0x5d, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x52, 0x6f, 0x6c, 0x65, 0x54, 0x6f,
	...
	0x78, 0x74, 0x22, 0x5f, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65, 0x41, 0x64,
	0x64, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x17, 0x0a, 0x07,
	...
	0x65, 0x78, 0x74, 0x42, 0x48, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e, 0x66, 0x69,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x62, 0x06, 0x70,
...
var file_api_commands_user_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_api_commands_user_proto_goTypes = []interface{}{
	...
	(*UserRoleAddedEventData)(nil), // 2: commands.user.UserRoleAddedEventData
	(*common.UserMetadata)(nil),    // 3: common.UserMetadata
}
var file_api_commands_user_proto_depIdxs = []int32{
	3, // 0: commands.user.CreateUserCommand.user_metadata:type_name -> common.UserMetadata
...
func file_api_commands_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_commands_user_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
