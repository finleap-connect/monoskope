...
var file_api_domain_projections_cluster_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x65, 0x73, 0x42, 0x41, 0x5a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_api_domain_projections_cluster_proto_goTypes = []interface{}{
	...
	(*ClusterAccess)(nil),     // 1: projections.ClusterAccess
	(*LifecycleMetadata)(nil), // 2: projections.LifecycleMetadata
}
var file_api_domain_projections_cluster_proto_depIdxs = []int32{
	2, // 0: projections.Cluster.metadata:type_name -> projections.LifecycleMetadata
	0, // 1: projections.ClusterAccess.cluster:type_name -> projections.Cluster
