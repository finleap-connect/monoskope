...
var file_api_domain_queryhandler_service_proto_rawDesc = []byte{
	...
	,
...
var file_api_domain_queryhandler_service_proto_goTypes = []interface{}{
	...
	(*projections.ClusterRegistration)(nil), // 8: projections.ClusterRegistration
...
var file_api_domain_queryhandler_service_proto_depIdxs = []int32{
	...
	0,  // 12: domain.ClusterRegistration.GetAll:input_type -> domain.GetAllRequest
	2,  // 13: domain.ClusterRegistration.GetPending:input_type -> google.protobuf.Empty
	2,  // 14: domain.K8sOperator.GetCluster:input_type -> google.protobuf.Empty
	2,  // 15: domain.K8sOperator.Retrieve:input_type -> google.protobuf.Empty
	3,  // 16: domain.User.GetAll:output_type -> projections.User
	3,  // 17: domain.User.GetById:output_type -> projections.User
	3,  // 18: domain.User.GetByEmail:output_type -> projections.User
	4,  // 19: domain.User.GetRoleBindingsById:output_type -> projections.UserRoleBinding
	5,  // 20: domain.Tenant.GetAll:output_type -> projections.Tenant
	5,  // 21: domain.Tenant.GetById:output_type -> projections.Tenant
	5,  // 22: domain.Tenant.GetByName:output_type -> projections.Tenant
	6,  // 23: domain.Tenant.GetUsers:output_type -> projections.TenantUser
	7,  // 24: domain.Cluster.GetAll:output_type -> projections.Cluster
	7,  // 25: domain.Cluster.GetById:output_type -> projections.Cluster
	7,  // 26: domain.Cluster.GetByName:output_type -> projections.Cluster
	1,  // 27: domain.Cluster.GetBootstrapToken:output_type -> google.protobuf.StringValue
	8,  // 28: domain.ClusterRegistration.GetAll:output_type -> projections.ClusterRegistration
	8,  // 29: domain.ClusterRegistration.GetPending:output_type -> projections.ClusterRegistration
	7,  // 30: domain.K8sOperator.GetCluster:output_type -> projections.Cluster
	9,  // 31: domain.K8sOperator.Retrieve:output_type -> eventsourcing.Event
