...
var file_api_domain_queryhandler_service_proto_rawDesc = []byte{
	...
	0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x32, 0xb5,
	0x01, 0x0a, 0x0d, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x12, 0x52, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x41, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x42, 0x79, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1c,
	...
	0x65, 0x72, 0x30, 0x01, 0x12, 0x50, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74,
	0x65, 0x72, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x42, 0x79, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64,
	0x12, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	...
	0x73, 0x74, 0x65, 0x72, 0x30, 0x01, 0x32, 0x58, 0x0a, 0x0b, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	...
	,
...
var file_api_domain_queryhandler_service_proto_depIdxs = []int32{
	...
	3,  // 15: domain.K8sOperator.GetCluster:input_type -> google.protobuf.Empty
	3,  // 16: domain.K8sOperator.Retrieve:input_type -> google.protobuf.Empty
	4,  // 17: domain.User.GetAll:output_type -> projections.User
	4,  // 18: domain.User.GetById:output_type -> projections.User
	4,  // 19: domain.User.GetByEmail:output_type -> projections.User
	5,  // 20: domain.User.GetRoleBindingsById:output_type -> projections.UserRoleBinding
	6,  // 21: domain.Tenant.GetAll:output_type -> projections.Tenant
	6,  // 22: domain.Tenant.GetById:output_type -> projections.Tenant
	6,  // 23: domain.Tenant.GetByName:output_type -> projections.Tenant
	7,  // 24: domain.Tenant.GetUsers:output_type -> projections.TenantUser
	8,  // 25: domain.Cluster.GetAll:output_type -> projections.Cluster
	8,  // 26: domain.Cluster.GetById:output_type -> projections.Cluster
	8,  // 27: domain.Cluster.GetByName:output_type -> projections.Cluster
	2,  // 28: domain.Cluster.GetBootstrapToken:output_type -> google.protobuf.StringValue
	8,  // 29: domain.ClusterAccess.GetClusterAccessByTenantId:output_type -> projections.Cluster
	8,  // 30: domain.ClusterAccess.GetClusterAccessByUserId:output_type -> projections.Cluster
	9,  // 31: domain.Certificate.GetCertificate:output_type -> projections.Certificate
	8,  // 32: domain.K8sOperator.GetCluster:output_type -> projections.Cluster
