...
var file_api_domain_queryhandler_service_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6e, 0x74, 0x55, 0x73, 0x65, 0x72, 0x30, 0x01, 0x32, 0xed, 0x02, 0x0a, 0x07, 0x43,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65,
	0x12, 0x58, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x65,
	0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x12, 0x1c, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72,
	0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x20, 0x2e, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x65,
	0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x32, 0xa4, 0x01, 0x0a, 0x13, 0x43,
...
var file_api_domain_queryhandler_service_proto_goTypes = []interface{}{
	...
	(*projections.ClusterCertificates)(nil), // 8: projections.ClusterCertificates
	(*projections.ClusterRegistration)(nil), // 9: projections.ClusterRegistration
...
var file_api_domain_queryhandler_service_proto_depIdxs = []int32{
	...
	1,  // 12: domain.Cluster.GetClusterCertificates:input_type -> google.protobuf.StringValue
	0,  // 13: domain.ClusterRegistration.GetAll:input_type -> domain.GetAllRequest
	2,  // 14: domain.ClusterRegistration.GetPending:input_type -> google.protobuf.Empty
	2,  // 15: domain.K8sOperator.GetCluster:input_type -> google.protobuf.Empty
	2,  // 16: domain.K8sOperator.Retrieve:input_type -> google.protobuf.Empty
	3,  // 17: domain.User.GetAll:output_type -> projections.User
	3,  // 18: domain.User.GetById:output_type -> projections.User
	3,  // 19: domain.User.GetByEmail:output_type -> projections.User
	4,  // 20: domain.User.GetRoleBindingsById:output_type -> projections.UserRoleBinding
	5,  // 21: domain.Tenant.GetAll:output_type -> projections.Tenant
	5,  // 22: domain.Tenant.GetById:output_type -> projections.Tenant
	5,  // 23: domain.Tenant.GetByName:output_type -> projections.Tenant
	6,  // 24: domain.Tenant.GetUsers:output_type -> projections.TenantUser
	7,  // 25: domain.Cluster.GetAll:output_type -> projections.Cluster
	7,  // 26: domain.Cluster.GetById:output_type -> projections.Cluster
	7,  // 27: domain.Cluster.GetByName:output_type -> projections.Cluster
	1,  // 28: domain.Cluster.GetBootstrapToken:output_type -> google.protobuf.StringValue
	8,  // 29: domain.Cluster.GetClusterCertificates:output_type -> projections.ClusterCertificates
	9,  // 30: domain.ClusterRegistration.GetAll:output_type -> projections.ClusterRegistration
	9,  // 31: domain.ClusterRegistration.GetPending:output_type -> projections.ClusterRegistration
	7,  // 32: domain.K8sOperator.GetCluster:output_type -> projections.Cluster
	10, // 33: domain.K8sOperator.Retrieve:output_type -> eventsourcing.Event
