...
var file_api_domain_queryhandler_service_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x38, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x41, 0x6c,
	...
	0x64, 0x22, 0x61, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x67,
	...
	0x54, 0x79, 0x70, 0x65, 0x22, 0x3a, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x22, 0x26, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xc9, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65,
	0x32, 0xb5, 0x01, 0x0a, 0x0d, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x41, 0x63, 0x63, 0x65,
	...
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x30, 0x01, 0x32, 0x58, 0x0a, 0x0b, 0x43, 0x65, 0x72, 0x74,
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x49, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x43, 0x65,
	0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x2e, 0x64, 0x6f, 0x6d, 0x61,
	0x69, 0x6e, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61,
...
var file_api_domain_queryhandler_service_proto_goTypes = []interface{}{
	...
	(*projections.User)(nil),            // 5: projections.User
	(*projections.UserRoleBinding)(nil), // 6: projections.UserRoleBinding
	(*projections.Tenant)(nil),          // 7: projections.Tenant
	(*projections.TenantUser)(nil),      // 8: projections.TenantUser
	(*projections.Cluster)(nil),         // 9: projections.Cluster
...
var file_api_domain_queryhandler_service_proto_depIdxs = []int32{
	...
	4,  // 1: domain.User.GetById:input_type -> google.protobuf.StringValue
	4,  // 2: domain.User.GetByEmail:input_type -> google.protobuf.StringValue
	4,  // 3: domain.User.GetRoleBindingsById:input_type -> google.protobuf.StringValue
	2,  // 4: domain.User.GetCount:input_type -> domain.GetCountRequest
	0,  // 5: domain.Tenant.GetAll:input_type -> domain.GetAllRequest
	4,  // 6: domain.Tenant.GetById:input_type -> google.protobuf.StringValue
	4,  // 7: domain.Tenant.GetByName:input_type -> google.protobuf.StringValue
	4,  // 8: domain.Tenant.GetUsers:input_type -> google.protobuf.StringValue
	0,  // 9: domain.Cluster.GetAll:input_type -> domain.GetAllRequest
	4,  // 10: domain.Cluster.GetById:input_type -> google.protobuf.StringValue
	4,  // 11: domain.Cluster.GetByName:input_type -> google.protobuf.StringValue
	4,  // 12: domain.Cluster.GetBootstrapToken:input_type -> google.protobuf.StringValue
	4,  // 13: domain.ClusterAccess.GetClusterAccessByTenantId:input_type -> google.protobuf.StringValue
	4,  // 14: domain.ClusterAccess.GetClusterAccessByUserId:input_type -> google.protobuf.StringValue
	1,  // 15: domain.Certificate.GetCertificate:input_type -> domain.GetCertificateRequest
	5,  // 16: domain.User.GetAll:output_type -> projections.User
	5,  // 17: domain.User.GetById:output_type -> projections.User
	5,  // 18: domain.User.GetByEmail:output_type -> projections.User
	6,  // 19: domain.User.GetRoleBindingsById:output_type -> projections.UserRoleBinding
	3,  // 20: domain.User.GetCount:output_type -> domain.GetCountResult
	7,  // 21: domain.Tenant.GetAll:output_type -> projections.Tenant
	7,  // 22: domain.Tenant.GetById:output_type -> projections.Tenant
	7,  // 23: domain.Tenant.GetByName:output_type -> projections.Tenant
	8,  // 24: domain.Tenant.GetUsers:output_type -> projections.TenantUser
	9,  // 25: domain.Cluster.GetAll:output_type -> projections.Cluster
	9,  // 26: domain.Cluster.GetById:output_type -> projections.Cluster
	9,  // 27: domain.Cluster.GetByName:output_type -> projections.Cluster
	4,  // 28: domain.Cluster.GetBootstrapToken:output_type -> google.protobuf.StringValue
	9,  // 29: domain.ClusterAccess.GetClusterAccessByTenantId:output_type -> projections.Cluster
	9,  // 30: domain.ClusterAccess.GetClusterAccessByUserId:output_type -> projections.Cluster
	10, // 31: domain.Certificate.GetCertificate:output_type -> projections.Certificate
