...
func (c *clusterAccessClient) GetClusterAccess(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (ClusterAccess_GetClusterAccessClient, error) {
	...
	x := &clusterAccessGetClusterAccessClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type clusterAccessGetClusterAccessClient struct {
	grpc.ClientStream
}

func (x *clusterAccessGetClusterAccessClient) Recv() (*projections.ClusterAccess, error) {
...
func _ClusterAccess_GetClusterAccess_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(emptypb.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ClusterAccessServer).GetClusterAccess(m, &clusterAccessGetClusterAccessServer{stream})
}
...
type clusterAccessGetClusterAccessServer struct {
	grpc.ServerStream
}
...
func (c *auditLogClient) GetByUser(ctx context.Context, in *GetByUserRequest, opts ...grpc.CallOption) (AuditLog_GetByUserClient, error) {
	stream, err := c.cc.NewStream(ctx, &AuditLog_ServiceDesc.Streams[1], "/domain.AuditLog/GetByUser", opts...)
	if err != nil {
		return nil, err
	}
	x := &auditLogGetByUserClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type auditLogGetByUserClient struct {
	grpc.ClientStream
}

func (x *auditLogGetByUserClient) Recv() (*audit.HumanReadableEvent, error) {
	m := new(audit.HumanReadableEvent)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *auditLogClient) GetUserActions(ctx context.Context, in *GetUserActionsRequest, opts ...grpc.CallOption) (AuditLog_GetUserActionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &AuditLog_ServiceDesc.Streams[2], "/domain.AuditLog/GetUserActions", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *auditLogClient) GetUsersOverview(ctx context.Context, in *GetUsersOverviewRequest, opts ...grpc.CallOption) (AuditLog_GetUsersOverviewClient, error) {
	stream, err := c.cc.NewStream(ctx, &AuditLog_ServiceDesc.Streams[3], "/domain.AuditLog/GetUsersOverview", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedAuditLogServer) GetByUser(*GetByUserRequest, AuditLog_GetByUserServer) error {
	return status.Errorf(codes.Unimplemented, "method GetByUser not implemented")
}
...
func _AuditLog_GetByUser_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetByUserRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AuditLogServer).GetByUser(m, &auditLogGetByUserServer{stream})
}
...
type auditLogGetByUserServer struct {
	grpc.ServerStream
}

func (x *auditLogGetByUserServer) Send(m *audit.HumanReadableEvent) error {
	return x.ServerStream.SendMsg(m)
}
...
type k8SAuthZClient struct {
	cc grpc.ClientConnInterface
}

func NewK8SAuthZClient(cc grpc.ClientConnInterface) K8SAuthZClient {
	return &k8SAuthZClient{cc}
}

func (c *k8SAuthZClient) GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (K8SAuthZ_GetAllClient, error) {
	stream, err := c.cc.NewStream(ctx, &K8SAuthZ_ServiceDesc.Streams[0], "/domain.K8sAuthZ/GetAll", opts...)
	if err != nil {
		return nil, err
	}
	x := &k8SAuthZGetAllClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type k8SAuthZGetAllClient struct {
	grpc.ClientStream
}

func (x *k8SAuthZGetAllClient) Recv() (*wrapperspb.BytesValue, error) {
...
func (c *k8SAuthZClient) GetByClusterId(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (K8SAuthZ_GetByClusterIdClient, error) {
	stream, err := c.cc.NewStream(ctx, &K8SAuthZ_ServiceDesc.Streams[1], "/domain.K8sAuthZ/GetByClusterId", opts...)
	if err != nil {
		return nil, err
	}
	x := &k8SAuthZGetByClusterIdClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type k8SAuthZGetByClusterIdClient struct {
	grpc.ClientStream
}

func (x *k8SAuthZGetByClusterIdClient) Recv() (*wrapperspb.BytesValue, error) {
	m := new(wrapperspb.BytesValue)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
// K8SAuthZServer is the server API for K8SAuthZ service.
// All implementations must embed UnimplementedK8SAuthZServer
// for forward compatibility
type K8SAuthZServer interface {
	...
	mustEmbedUnimplementedK8SAuthZServer()
}
...
func (UnimplementedK8SAuthZServer) GetAll(*emptypb.Empty, K8SAuthZ_GetAllServer) error {
	return status.Errorf(codes.Unimplemented, "method GetAll not implemented")
}
func (UnimplementedK8SAuthZServer) GetByClusterId(*wrapperspb.StringValue, K8SAuthZ_GetByClusterIdServer) error {
	return status.Errorf(codes.Unimplemented, "method GetByClusterId not implemented")
}
func (UnimplementedK8SAuthZServer) mustEmbedUnimplementedK8SAuthZServer() {}

// UnsafeK8SAuthZServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to K8SAuthZServer will
// result in compilation errors.
...
func RegisterK8SAuthZServer(s grpc.ServiceRegistrar, srv K8SAuthZServer) {
	s.RegisterService(&K8SAuthZ_ServiceDesc, srv)
}

func _K8SAuthZ_GetAll_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(emptypb.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(K8SAuthZServer).GetAll(m, &k8SAuthZGetAllServer{stream})
}
...
type k8SAuthZGetAllServer struct {
	grpc.ServerStream
}

func (x *k8SAuthZGetAllServer) Send(m *wrapperspb.BytesValue) error {
	return x.ServerStream.SendMsg(m)
}

func _K8SAuthZ_GetByClusterId_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(wrapperspb.StringValue)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(K8SAuthZServer).GetByClusterId(m, &k8SAuthZGetByClusterIdServer{stream})
}
...
type k8SAuthZGetByClusterIdServer struct {
	grpc.ServerStream
}

func (x *k8SAuthZGetByClusterIdServer) Send(m *wrapperspb.BytesValue) error {
	return x.ServerStream.SendMsg(m)
}

// K8SAuthZ_ServiceDesc is the grpc.ServiceDesc for K8SAuthZ service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
