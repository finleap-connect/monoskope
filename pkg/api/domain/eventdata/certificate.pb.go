...
type CertificateIssued struct {
	...
	Certificate *common.Certificate `protobuf:"bytes,1,opt,name=certificate,proto3" json:"certificate,omitempty"`
}
...
func (x *CertificateIssued) GetCertificate() *common.Certificate {
	if x != nil {
...
var file_api_domain_eventdata_certificate_proto_rawDesc = []byte{
	...
	0x6e, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4a, 0x0a, 0x11, 0x43,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43,
...
var file_api_domain_eventdata_certificate_proto_depIdxs = []int32{
	2, // 0: eventdata.CertificateIssued.certificate:type_name -> common.Certificate
