...
type ClusterRegisteredEventData struct {
...
func (x *ClusterRegisteredEventData) Reset() {
	*x = ClusterRegisteredEventData{}
...
func (x *ClusterRegisteredEventData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterRegisteredEventData) ProtoMessage() {}

func (x *ClusterRegisteredEventData) ProtoReflect() protoreflect.Message {
	mi := &file_api_domain_eventdata_cluster_proto_msgTypes[0]
...
// Deprecated: Use ClusterRegisteredEventData.ProtoReflect.Descriptor instead.
func (*ClusterRegisteredEventData) Descriptor() ([]byte, []int) {
	return file_api_domain_eventdata_cluster_proto_rawDescGZIP(), []int{0}
}

func (x *ClusterRegisteredEventData) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ClusterRegisteredEventData) GetApiServerAddress() string {
	if x != nil {
...
func (x *ClusterRegisteredEventData) GetCaCertificate() []byte {
	if x != nil {
...
type ClusterCreatedEventData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ClusterCreatedEventData) Reset() {
	*x = ClusterCreatedEventData{}
	if protoimpl.UnsafeEnabled {
...
func (x *ClusterCreatedEventData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterCreatedEventData) ProtoMessage() {}

func (x *ClusterCreatedEventData) ProtoReflect() protoreflect.Message {
	mi := &file_api_domain_eventdata_cluster_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClusterCreatedEventData.ProtoReflect.Descriptor instead.
func (*ClusterCreatedEventData) Descriptor() ([]byte, []int) {
	return file_api_domain_eventdata_cluster_proto_rawDescGZIP(), []int{1}
}

func (x *ClusterCreatedEventData) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ClusterCreatedEventData) GetApiServerAddress() string {
	if x != nil {
		return x.ApiServerAddress
	}
	return ""
...
func (x *ClusterCreatedEventData) GetCaCertificate() []byte {
	if x != nil {
		return x.CaCertificate
	}
	return nil
...
var file_api_domain_eventdata_cluster_proto_rawDesc = []byte{
	...
	0x85, 0x01, 0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x65, 0x72, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x12,
	...
	0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x63, 0x61, 0x43, 0x65, 0x72, 0x74,
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x22, 0x82, 0x01, 0x0a, 0x17, 0x43, 0x6c, 0x75, 0x73,
	0x74, 0x65, 0x72, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2c, 0x0a, 0x12, 0x61, 0x70, 0x69, 0x5f, 0x73,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x61, 0x5f, 0x63, 0x65, 0x72, 0x74,
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x63,
	0x61, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x42, 0x4b, 0x5a, 0x49,
...
var file_api_domain_eventdata_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_domain_eventdata_cluster_proto_goTypes = []interface{}{
	(*ClusterRegisteredEventData)(nil), // 0: eventdata.ClusterRegisteredEventData
	(*ClusterCreatedEventData)(nil),    // 1: eventdata.ClusterCreatedEventData
}
...
func file_api_domain_eventdata_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_domain_eventdata_cluster_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClusterRegisteredEventData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_domain_eventdata_cluster_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClusterCreatedEventData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
