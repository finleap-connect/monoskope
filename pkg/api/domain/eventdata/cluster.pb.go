...
func (x *ClusterRegistered) GetCaCertificate() []byte {
	if x != nil {
...
type ClusterRegistrationApproved struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ClusterRegistrationApproved) Reset() {
	*x = ClusterRegistrationApproved{}
	if protoimpl.UnsafeEnabled {
...
func (x *ClusterRegistrationApproved) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterRegistrationApproved) ProtoMessage() {}

func (x *ClusterRegistrationApproved) ProtoReflect() protoreflect.Message {
	mi := &file_api_domain_eventdata_cluster_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClusterRegistrationApproved.ProtoReflect.Descriptor instead.
func (*ClusterRegistrationApproved) Descriptor() ([]byte, []int) {
	return file_api_domain_eventdata_cluster_proto_rawDescGZIP(), []int{1}
}

func (x *ClusterRegistrationApproved) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ClusterRegistrationApproved) GetApiServerAddress() string {
	if x != nil {
		return x.ApiServerAddress
	}
	return ""
...
func (x *ClusterRegistrationApproved) GetCaCertificate() []byte {
	if x != nil {
		return x.CaCertificate
	}
	return nil
...
func (x *ClusterCreated) GetCaCertificate() []byte {
	if x != nil {
		return x.CaCertificate
	}
	return nil
...
var file_api_domain_eventdata_cluster_proto_rawDesc = []byte{
	...
	0x7c, 0x0a, 0x11, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	0x65, 0x72, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2c, 0x0a, 0x12, 0x61, 0x70, 0x69, 0x5f,
	...
	,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x63, 0x61, 0x43, 0x65, 0x72, 0x74, 0x69,
	0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x22, 0x79, 0x0a, 0x0e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x61, 0x70, 0x69, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x61,
	0x5f, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x0d, 0x63, 0x61, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74,
	0x65, 0x42, 0x4b, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e, 0x66, 0x69, 0x67, 0x6f,
	...
	0x6d, 0x61, 0x69, 0x6e, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x64, 0x61, 0x74, 0x61, 0x62, 0x06,
...
var file_api_domain_eventdata_cluster_proto_goTypes = []interface{}{
	...
	(*ClusterRegistrationApproved)(nil), // 1: eventdata.ClusterRegistrationApproved
	(*ClusterCreated)(nil),              // 2: eventdata.ClusterCreated
}
...
func file_api_domain_eventdata_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_domain_eventdata_cluster_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClusterRegistrationApproved); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
