...
func init() {
	...
	flags.StringVarP(&grpcApiAddr, "grpc-api-addr", "g", ":8080", "Address the gRPC service will listen on")
	flags.StringVarP(&httpApiAddr, "http-api-addr", "h", ":8081", "Address the HTTP service will listen on")
